...
如果想先了解判断逻辑，可以阅读[证据优先的简历与 JD 匹配方法](https://resumeproof.szw19990924.chatgpt.site/guide?utm_source=github&utm_medium=referral&utm_campaign=skill_repo_202609)。
